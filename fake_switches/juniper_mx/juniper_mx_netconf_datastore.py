...
class JuniperMxNetconfDatastore(JuniperQfxCopperNetconfDatastore):
    ...
    def parse_interface(self, conf, interface_node):
        ...
        if port_name == "irb":
            ...
            super().parse_interface(conf, interface_node)
    ...
    def handle_interface_operation(self, conf, port, operation):
    ...
    def to_irb_interfaces(self, vlan_ports):
        ...
        for vlan_port in vlan_ports:
            ...
            if vlan_port.ips:
                unit["familiy"] = {
                    "inet": [{"address": {"name": ip}} for ip in vlan_port.ips]
                }
    ...
    def vlan_to_etree(self, vlan):
        etree = super().vlan_to_etree(vlan)
